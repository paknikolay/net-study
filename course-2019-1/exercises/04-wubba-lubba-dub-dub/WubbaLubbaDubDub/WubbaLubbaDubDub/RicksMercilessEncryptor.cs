...
namespace WubbaLubbaDubDub
{
    public static class RicksMercilessEncryptor
    {
        ...
        {
            return s.Substring((int)((s.Length  + 1)/ 2));
        }

        /// <summary>
        /// Возвращает строку, в которой все вхождения строки <see cref="old"/> заменены на строку <see cref="@new"/>.
        /// </summary>
        public static string Replace2(this string s, string old, string @new)
        {
        ...
        public static string CharsToCodes(this string s)
        {
            ...
            */
            ...
            return string.Join("", s.Select(c => @"\u" + (c - 0).ToString("X4")));
        ...
        {
            return string.Concat(s.Select(c =>  (char)((c + 1) % 256)));
        }
